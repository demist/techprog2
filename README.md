...
## :fire: [Лекция №9](https://github.com/demist/techprog2/blob/main/слайды%20лекций/ТП%20ВШБ%202021%20-%202%2C%20лекция%209.pdf) *(неделя 5)*
...
## :fire: [Лекция №10](https://github.com/demist/techprog2/blob/main/слайды%20лекций/ТП%20ВШБ%202021%20-%202%2C%20лекция%2010.pdf) *(неделя 5)*
...
- Вы можете использовать любые материалы, как и те, которые есть в этом репозитории, так и те, которые найдете в интеренете. Запрещено только коллективное творчество с однокурсниками и списывание друг у друга
